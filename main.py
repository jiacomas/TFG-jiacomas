...
def visualize_data(data: pd.DataFrame = None):
    ...
    from src.data.analysis.analysis import count_ods, clean_nan, get_correlation, get_average, get_max, get_min, get_length_description, get_organization, save_dict
    ...
    if input("visualitzar ODS? Y/N: ").upper() == "Y":
        ...
        save_visualization(bar_chart_distribution_ods_register(num_ods_anunci), ODS_DISTRIBUTION_REGISTER_VISUALIZATION)
